...
```{r EDA, fig.height=5, fig.width=5}
...
```{r EDA6, fig.height=5, fig.width=6}
elections_year %>% 
  filter(voted == 1) %>% 
...
#2004 - Presidential
#2006 - Midterm After Incumbent President
#2008 - Presidential
#2010 - Midterm After New President
#2012 - Presidential
#2014 - Midterm After Incumbent President
#2016 - Presidential
#2018 - Midterm After New President
```
...
full_model <- glm(voted ~ YEAR + sex + current_student + citizen + employed + 
                    ...
                    highest_education + sex*employed + 
