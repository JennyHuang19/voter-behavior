...
All of the VIF values are under the threshold of 10 (see table in Appendix D), indicating that there is no evidence of multicollinearity in our data.
...
threshold that yields high sensitivity and low values of the false positive rate (1 - specificity).
