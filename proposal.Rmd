...
`track_popularity`. The variable is numeric and ranges from values of 0 (least popular)
to 100 (most popular). The popularity is reportedly measured by the amount of streams for a given track [5]. A distribution of `track_popularity` can be seen below.
...
- [5] https://stackoverflow.com/questions/17727208/spotify-how-is-a-tracks-popularity-value-determined
